...
public:
  ...
  Book(const Book &oldObj) {
    mem_request_for_name(); // request memory allocation
...
int main() {
  ...
  /* NEW: It is now safe to assign an object to another object
  (copy constructor/ copy assignment operator will be called)
  */
